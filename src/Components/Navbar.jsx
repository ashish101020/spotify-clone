    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="bg-purple-500 text-black w-7 h-7 flex items-center justify-center rounded-full cursor-pointer">
            D
          </p>
        </div>
      </div>
      <div className="flex items-center gap-2 mt-4">
        ...
        <p className="bg-black text-whit e px-4 py-1 rounded-2xl cursor-pointer">Music</p>
